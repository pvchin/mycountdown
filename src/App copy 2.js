...
const calculateTimeLeft = targetDateString => {
  ...
  //console.log('diff', typeof targetDateString, difference, targetDateString);
  let timeLeft = {};
...
function App() {
  ...
  const targetDate = addDays(new Date(), 18);
  //const targetDate = dayjs().add(18, 'day').$d
  ...
  console.log('tdate', typeof tDate, targetDate);
  console.log('deadline', deadlinedate);

  const getTimeLeft = tDate => {
    const tempdate = addDays(new Date(), 18);
    const targetDate = tempdate
